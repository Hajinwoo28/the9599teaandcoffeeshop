...
class MenuItem(db.Model):
    """
    Represents a drink or snack available on the menu.
    """
...
class Ingredient(db.Model):
    """
    Represents raw materials in the shop (e.g., Milk, Tea, Cups, Potatoes).
    """
...
<body>
    ...
    <div id="size-modal" class="modal">
        <div class="modal-content" style="text-align:left;">
            ...
            <label style="font-weight:800; color:#8D6E63; font-size:0.8rem; text-transform:uppercase;">2. Add-ons</label>
                    ...
                    cartItemsList.innerHTML += `
                        <div class="cart-item">
                            <div class="item-details">
                                <h4>${escapeHTML(item.name)}${sizeLabel}${addonLabel}</h4>
...
def import_legacy():
    ...
    and safely inject those historical rows into the digital system.
    """
    if not session.get('is_admin'): 
        return jsonify({"error": "Unauthorized"}), 403
