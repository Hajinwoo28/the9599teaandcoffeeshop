...
# --- 2. CLOUD & LOCAL DATABASE CONFIGURATION ---
...
<body>
    ...
    <header>
        <div class="logo-area">
            ...
            <div style="display:flex; flex-direction: column;">
                ...
                <span id="store-hours-display" style="font-size: 0.65rem; font-weight: 600; color: #8D6E63; display: none;">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            if (hoursDisplay && hoursDisplay.innerText.trim().length > 6) {
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Poppins', sans-serif; }
        ...
        .btn-add-item { background: #10B981; color: white; border: none; padding: 10px 20px; border-radius: 8px; font-weight: 800; font-size: 0.9rem; cursor: pointer; display: flex; align-items: center; gap: 8px; transition: all 0.2s; box-shadow: 0 4px 10px rgba(16, 185, 129, 0.3); }
        .btn-add-item:hover { background: #059669; transform: translateY(-2px); box-shadow: 0 6px 15px rgba(16, 185, 129, 0.4); }
