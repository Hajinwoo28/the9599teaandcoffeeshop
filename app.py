...
<div id="perm-modal" class="modal">
    <div class="modal-content" style="text-align:center;">
        ...
        <h2 style="margin-bottom:8px;">Order Limit Reached</h2>
        <p style="color:var(--toffee); font-size:0.85rem; line-height:1.55; margin-bottom:14px;">
            You can only order up to <strong>5 items</strong> at a time.<br>
            To order more, ask the staff and give them your request code:
        </p>
        <div class="perm-code-box" id="perm-request-code">—</div>
        <p style="font-size:0.75rem; color:var(--toffee); margin-bottom:6px;">Show this code to the cashier. They will unlock more items for you.</p>
...
<script>
    ...
    const ITEM_PHOTOS = {
        ...
        /* ── MILK SERIES (NEW) ── */
        'Ube Milk':       { src: '/static/images/menu_milk_series.jpg', pos: '10% 50%' },
        'Mango Milk':     { src: '/static/images/menu_milk_series.jpg', pos: '30% 50%' },
        'Strawberry Milk':{ src: '/static/images/menu_milk_series.jpg', pos: '50% 50%' },
        'Hazelnut Milk':  { src: '/static/images/menu_milk_series.jpg', pos: '70% 50%' },
        'Blueberry Milk': { src: '/static/images/menu_milk_series.jpg', pos: '90% 50%' },
        /* ── FRUIT SODA (NEW) ── */
        'Lychee Mogu Soda':  { src: '/static/images/menu_fruit_soda.jpg', pos: '10% 50%' },
        'Green Apple Soda':  { src: '/static/images/green_apple_soda.jpg', pos: '50% 50%' },
        'Strawberry Soda':   { src: '/static/images/menu_fruit_soda.jpg', pos: '63% 50%' },
        'Blueberry Soda':    { src: '/static/images/menu_fruit_soda.jpg', pos: '90% 50%' },
    };
                ...
                cartItemsList.innerHTML += `
                    <div class="cart-item">
                        <div class="item-details">
                            <h4>${escapeHTML(item.name)}<span style="color:var(--toffee); font-weight:500;">${sizeLabel}${flavorLabel}</span></h4>
    ...
    async function submitOrder() {
        ...
        // Check order limit (5 items max without permission)
        if (cart.length > ORDER_LIMIT && !permissionGranted) {
            ...
            showToast('🛑 Over the 5-item limit — ask staff for permission.', 'error');
...
<body>
    ...
    <script>
        ...
        const ADMIN_ITEM_PHOTOS = {
            ...
            'Ube Milk':                    '/static/images/menu_milk_series.jpg',
            'Mango Milk':                  '/static/images/menu_milk_series.jpg',
            'Strawberry Milk':             '/static/images/menu_milk_series.jpg',
            'Hazelnut Milk':               '/static/images/menu_milk_series.jpg',
            'Blueberry Milk':              '/static/images/menu_milk_series.jpg',
            'Lychee Mogu Soda':            '/static/images/menu_fruit_soda.jpg',
            'Green Apple Soda':            '/static/images/green_apple_soda.jpg',
            'Strawberry Soda':             '/static/images/menu_fruit_soda.jpg',
            'Blueberry Soda':              '/static/images/menu_fruit_soda.jpg',
        };
