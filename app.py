...
<div id="perm-modal" class="modal">
    <div class="modal-content" style="text-align:center; max-width:440px; width:92vw;">
        ...
        <p style="color:var(--toffee); font-size:0.85rem; line-height:1.55; margin-bottom:14px;">
            ...
            Fill in the form below and send a request to the admin for permission to order 5 or more.
        </p>
...
<script>
    ...
    async function submitOrder() {
        ...
        if (milkteaCount > MILKTEA_LIMIT && !permissionGranted) {
            ...
            // Play urgent sound
            playPermissionRequestSound();
            showToast(`🛑 Over the ${MILKTEA_LIMIT}-milktea limit — ask staff for permission.`, 'error');
...
<body>
    ...
    <script>
        ...
        // Automatically redirects to /login if session expired (403)
        ...
        // Poll permission requests every 5 seconds
