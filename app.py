    ...
    <aside class="sidebar">
        <div>
            ...
            <nav class="nav-links">
                ...
                <div class="nav-item" onclick="switchTab('audit', 'Audit Trail (Transparency)', this)">
...
def get_audit_logs():
    """
    Admin Only. Retrieves the system's uneditable audit trail for Transparency tracking.
    """
    if not session.get('is_admin'):
        return jsonify([]), 403
